...
const TemplateResetPassword = (name, resetLink) => `
  <table width="100%" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" align="center">
      <tbody>
        <!-- Header Row -->
        <tr>
          ...
          <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center">
              <tbody>
                ...
                <tr>
                  <td style="font-family:Helvetica, Arial, sans-serif; font-size:13px; color:#000000; text-align:center; line-height:18px; padding: 10px;">
                    Chúng tôi đã nhận được yêu cầu thiết lập lại mật khẩu cho tài khoản của bạn.
                  </td>
                </tr>
                <tr>
                  <td style="font-family:Helvetica, Arial, sans-serif; font-size:13px; color:#000000; text-align:center; line-height:18px; padding: 10px;">
                    Nhấn vào liên kết bên dưới để thiết lập lại mật khẩu của bạn:
                  </td>
                </tr>
                <tr>
                  <td style="text-align:center; padding: 20px;">
                    <a href="{{resetLink}}" style="background-color:#ee4d2d; color:#ffffff; padding:10px 20px; text-decoration:none; border-radius:5px;">Thiết lập lại mật khẩu</a>
                  </td>
                </tr>
                <tr>
                  <td style="font-family:Helvetica, Arial, sans-serif; font-size:13px; color:#000000; text-align:center; line-height:18px; padding: 10px;">
                    Liên kết này sẽ hết hạn trong 15 phút. Nếu bạn không yêu cầu thiết lập lại mật khẩu, vui lòng bỏ qua email này.
                  </td>
                </tr>
              </tbody>
            </table>
